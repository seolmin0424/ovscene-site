...
OVS.PRODUCTS = [
  ...
  { id: "tube-chair", name: "튜브 프레임 체어", cat: "가구", price: 168000, type: "stool",
    moments: ["focus", "month"], styles: ["modern"],
    desc: "무광 프레임과 단단한 좌판으로 만든 한 사람용 체어. 책상 옆에 놓아도 시선이 복잡하지 않습니다.",
    spec: { "소재": "스틸 · 패브릭", "크기": "폭 49 · 높이 76cm", "색상": "차콜 · 크림", "조립": "완성품" },
    why: "모던 테마의 빈 벽과 매트한 마감을 유지하는 대표 가구입니다." },
  { id: "slate-side-cart", name: "매트 사이드 카트", cat: "가구", price: 138000, type: "shelf",
    moments: ["focus", "refresh"], styles: ["modern"],
    desc: "자주 쓰는 물건만 보이게 정리하는 낮은 2단 카트. 방을 넓게 쓰기 위한 이동식 수납입니다.",
    spec: { "소재": "파우더 코팅 스틸", "크기": "42 × 32 × 55cm", "색상": "그레이 · 아이보리", "바퀴": "잠금 2개" },
    why: "작은 방에서 물건의 자리를 바꾸고 싶은 모던 취향에 맞습니다." },
  { id: "walnut-cabinet", name: "월넛 미니 캐비닛", cat: "가구", price: 224000, type: "shelf",
    moments: ["rest", "month"], styles: ["vintage"],
    desc: "낮은 월넛장과 브라스 손잡이. 벽 한 면에 오래된 방의 깊이를 더합니다.",
    spec: { "소재": "월넛 무늬목 · 황동", "크기": "70 × 35 × 58cm", "수납": "2단", "조립": "다리 결합" },
    why: "빈티지 테마의 따뜻한 나무결과 앰버 조명을 연결하는 중심 가구입니다." },
  { id: "amber-side-table", name: "앰버 글라스 사이드 테이블", cat: "가구", price: 158000, type: "tray",
    moments: ["drink", "rest"], styles: ["vintage"],
    desc: "유리 상판에 책 한 권과 잔 하나를 올리는 낮은 테이블. 저녁의 자리를 만듭니다.",
    spec: { "소재": "앰버 유리 · 브라스", "크기": "지름 42 · 높이 46cm", "하중": "12kg", "관리": "마른 천" },
    why: "한 잔과 작은 조명을 가까이 두는 빈티지 장면의 기본입니다." },
  { id: "lacquer-cube", name: "래커 큐브 테이블", cat: "가구", price: 149000, type: "stool",
    moments: ["refresh", "exam"], styles: ["kitsch"],
    desc: "선명한 색을 한 덩어리로 놓는 큐브형 테이블. 방의 중심을 빠르게 바꿉니다.",
    spec: { "소재": "래커 마감 MDF", "크기": "38 × 38 × 38cm", "색상": "레드 · 그린", "사용": "테이블 · 스툴" },
    why: "키치 테마의 큰 색면과 장난스러운 비율을 만드는 첫 가구입니다." },
  { id: "curve-lounge-chair", name: "컬러 라운지 체어", cat: "가구", price: 218000, type: "cushion",
    moments: ["rest", "refresh"], styles: ["kitsch"],
    desc: "둥근 등받이와 광택 패브릭으로 만든 체어. 하나만 두어도 방의 표정이 바뀝니다.",
    spec: { "소재": "벨벳 · 스틸", "크기": "폭 68 · 높이 74cm", "색상": "체리 레드 · 포레스트", "하중": "100kg" },
    why: "맥시멀한 색과 실루엣을 좋아하는 취향에 맞춘 대표 체어입니다." },
  { id: "graphic-mirror", name: "그래픽 스탠드 미러", cat: "가구", price: 189000, type: "mirror",
    moments: ["month", "refresh"], styles: ["kitsch"],
    desc: "컬러 프레임을 두른 전신 거울. 빛을 반사하면서 벽을 그래픽처럼 보이게 합니다.",
    spec: { "소재": "컬러 스틸 · 미러", "크기": "50 × 150cm", "설치": "벽 기대기", "색상": "레드 · 블랙" },
    why: "키치 테마에서 공간의 비율을 바꾸는 가장 큰 한 점입니다." },
  { id: "rattan-bench", name: "라탄 로우 벤치", cat: "가구", price: 138000, type: "stool",
    moments: ["morning", "rest"], styles: ["eco"],
    desc: "침대 끝이나 창가에 놓는 낮은 라탄 벤치. 옷과 책이 잠시 머무는 자리입니다.",
    spec: { "소재": "라탄 · 오크", "크기": "75 × 34 × 42cm", "마감": "무광 오일", "하중": "120kg" },
    why: "자연 소재를 선호하는 에코 테마의 동선을 부드럽게 만드는 가구입니다." },
  { id: "linen-floor-chair", name: "리넨 플로어 체어", cat: "가구", price: 122000, type: "cushion",
    moments: ["rain", "rest"], styles: ["eco"],
    desc: "바닥에 앉아 쉬는 시간을 위한 낮은 체어. 펴거나 접어 여백을 남길 수 있습니다.",
    spec: { "소재": "리넨 · 고밀도 폼", "크기": "폭 62 · 높이 52cm", "색상": "오트 · 모스", "커버": "분리 세탁" },
    why: "무리하게 가구를 늘리지 않으면서 앉는 방식을 바꾸고 싶을 때 제안됩니다." },
  { id: "chrome-module-shelf", name: "크롬 모듈 셀프", cat: "가구", price: 184000, type: "shelf",
    moments: ["focus", "month"], styles: ["metallic"],
    desc: "반사되는 크롬 선반과 투명 선반판. 물건을 두어도 공기가 가벼워 보입니다.",
    spec: { "소재": "크롬 스틸 · 아크릴", "크기": "60 × 30 × 82cm", "구성": "3단", "조립": "클립 방식" },
    why: "메탈릭 테마에서 빛과 물건을 함께 반사시키는 수납 가구입니다." },
  { id: "aluminum-stool", name: "알루미늄 스툴", cat: "가구", price: 128000, type: "stool",
    moments: ["drink", "focus"], styles: ["metallic"],
    desc: "가볍지만 단단한 알루미늄 스툴. 의자와 작은 테이블 사이로 씁니다.",
    spec: { "소재": "브러시드 알루미늄", "크기": "지름 36 · 높이 45cm", "무게": "3.4kg", "하중": "110kg" },
    why: "차갑고 매끈한 소재를 선호하는 메탈릭 취향의 기본 좌석입니다." },
  { id: "mirror-side-table", name: "미러 사이드 테이블", cat: "가구", price: 163000, type: "mirror",
    moments: ["drink", "refresh"], styles: ["metallic"],
    desc: "작은 빛도 반사해 존재감을 만드는 미러 상판 테이블. 물건을 적게 둘수록 예쁩니다.",
    spec: { "소재": "스테인리스 · 미러", "크기": "42 × 42 × 48cm", "마감": "헤어라인", "관리": "극세사 천" },
    why: "메탈릭 테마의 반사광과 단단한 실루엣을 완성하는 포인트 가구입니다." },
